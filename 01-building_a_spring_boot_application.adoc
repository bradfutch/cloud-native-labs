...
. Change the working directory to be _cloud-native-labs/my_work/cloud-native-spring_
+
  cd /cloud-native-labs/my_work/cloud-native-spring

. Open this project in your editor/IDE of choice.
+
*_STS Import Help_*
+
Select _File > Import…_. In the susequent dialog choose _Gradle > Existing Gradle Project_ then click the _Next_ button. In the _Import Gradle Project_ dialog browse to the _cloud-native-spring_ directory (e.g. _cloud-native-labs/my_work/cloud-native-spring_) then click the _Open_ button, then click the _Finish_ button.
...
Return to the Terminal session you opened previously and make sure your working directory is set to be _cloud-native-labs/my_work/cloud-native-spring_
...
. Create an application manifest in the root folder _cloud-native-labs/my_work/cloud-native-spring_
+
  touch manifest.yml
